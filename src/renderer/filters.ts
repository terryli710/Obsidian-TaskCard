 ...
 */
export function filterTaskItems(elems: HTMLElement[], taskValidator: TaskValidator): HTMLElement[] {
    if (!Array.isArray(elems) || typeof taskValidator.isValidTaskElement !== 'function') {
 ...
 */
export function getIndicesOfFilter(array: any[], filter: (element: any) => boolean): number[] {
