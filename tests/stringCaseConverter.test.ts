import {
  ...
  kebabToCamel,
  toCamelCase
} from '../src/utils/stringCaseConverter';
...
describe('string case conversion', () => {
  test('camelToKebab should convert camelCase to kebab-case', () => {
    ...
    expect(camelToKebab('anotherCamelCaseString')).toBe(
  ...
  test('kebabToCamel should convert kebab-case to camelCase', () => {
    ...
    expect(kebabToCamel('another-kebab-case-string')).toBe(
  ...
  test('toCamelCase should convert a word + space structure to camelCase', () => {
    ...
    expect(toCamelCase('   The    Slow   Brown   Fox   ')).toBe(
      'theSlowBrownFox'
    );
