...
describe('LabelModule', () => {
    ...
    test('editLabel should throw an error if the old label is not found', () => {
        expect(() => labelModule.editLabel('newLabel', 'nonexistentLabel')).toThrowError('Label not found');
    });
    ...
    test('deleteLabel should throw an error if the label is not found', () => {
        expect(() => labelModule.deleteLabel('nonexistentLabel')).toThrowError('Label not found');
    });
